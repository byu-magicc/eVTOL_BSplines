...
#calls the function to generate the samples
generator.generateSampledBSplineLookupTables()

#calls the function to generate the integrated matrix
generator.generateIntegratedBSplineLookupTables()
