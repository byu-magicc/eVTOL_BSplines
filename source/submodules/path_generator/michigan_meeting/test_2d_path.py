...
point_3 = np.array([[6],[5]])

waypoint_1 = Waypoint(location=point_1)
waypoint_3 = Waypoint(location=point_3)
waypoint_1.velocity = np.array([[1],[0]])
waypoint_3.velocity = np.array([[0],[1]])


intermediateLocations = point_2

waypoint_data = WaypointData(start_waypoint=waypoint_1,end_waypoint=waypoint_3, intermediate_locations=intermediateLocations)
